...
export const uk: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'Додати файл',
    stepOptions: 'Налаштування',
    stepRun: 'Запустити',
    stepDownload: 'Завантажити',
    working: 'Обробка…',
    cancel: 'Скасувати',
    startOver: 'Почати знову',
    addFileFirst: 'Спершу додайте файл.',
    fixOptions: 'Виправте позначені налаштування.',
    progressFallback: 'Обробляємо ваш файл…',
    setupErrorTitle: 'Помилка налаштування інструмента.',
    setupErrorBody: 'Для «{tool}» потрібен окремий редактор.',
    largeTitle: 'Попередження: великий файл.',
    largeBody: 'Цей інструмент усе одно працює локально, але через обмеження пам\'яті браузера на цьому пристрої він може бути повільнішим або не впоратися.',
    doneOne: 'Готово — ваш файл готовий.',
    doneMany: 'Готово — ваші файли готові.',
    reviewText: 'Перегляньте текст або завантажте результат.',
    extractedText: 'Видобутий текст · {n} символів',
    copy: 'Копіювати',
    madeHere: 'Зроблено просто тут, у вашому браузері. Ми його ніколи не бачили.',
    kindImage: 'зображення',
    kindFile: 'файл',
    dropOne: 'Перетягніть сюди {kind} або клацніть, щоб обрати',
    dropMany: 'Перетягніть сюди {kind} або клацніть, щоб обрати',
    dzTypesOne: '{kind} · один файл',
    dzTypesMany: '{kind} · один або кілька',
    dzPrivacy: 'Файли залишаються на вашому пристрої — нічого не завантажується.',
    dzAria: 'Додайте файли — перетягніть їх або активуйте, щоб обрати. Файли обробляються на вашому пристрої.',
    addedFiles: 'Додані файли',
    rejectedOne: 'Один файл не підходить для цього інструмента.',
    rejectedMany: '{n} файлів не підходять для цього інструмента.',
    rejectedSingle: 'Цей інструмент працює з одним файлом за раз, тож додано лише перший відповідний файл.',
  },
  promo: {
    disclosure: 'Реклама',
    heading: 'Вивчаєте німецьку?',
    body: 'NeoDeutsch навчає німецької: граматика, лексика та вимова — з поясненнями вашою рідною мовою.',
    cta: 'Спробувати безкоштовно',
    imgAlt: 'Райнеке, лис NeoDeutsch, у шарфі кольорів Німеччини',
  },
  tools: {
    merge: {
      name: "Об'єднати PDF",
