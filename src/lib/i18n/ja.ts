...
export const ja: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'ファイルを追加',
    stepOptions: 'オプションを設定',
    stepRun: '実行',
    stepDownload: 'ダウンロード',
    working: '処理中…',
    cancel: 'キャンセル',
    startOver: 'やり直す',
    addFileFirst: 'まずファイルを追加してください。',
    fixOptions: 'ハイライトされたオプションを修正してください。',
    progressFallback: 'ファイルを処理しています…',
    setupErrorTitle: 'ツールの初期化エラー。',
    setupErrorBody: '{tool} には専用エディタが必要です。',
    largeTitle: '大きなファイルの注意。',
    largeBody: 'このツールはあなたの端末内で動きますが、ブラウザのメモリの都合で動作が遅くなったり、この端末では失敗したりすることがあります。',
    doneOne: '完了 — ファイルの準備ができました。',
    doneMany: '完了 — ファイルの準備ができました。',
    reviewText: 'テキストのプレビューを確認するか、結果をダウンロードしてください。',
    extractedText: '抽出されたテキスト · {n} 文字',
    copy: 'コピー',
    madeHere: 'すべてあなたのブラウザ内で作成しました。私たちが中身を見ることはありません。',
    kindImage: '画像',
    kindFile: 'ファイル',
    dropOne: '{kind}をここにドロップ、またはクリックして選択',
    dropMany: '{kind}をここにドロップ、またはクリックして選択',
    dzTypesOne: '{kind} · 1ファイル',
    dzTypesMany: '{kind} · 1つでも複数でも',
    dzPrivacy: 'ファイルはあなたの端末に留まります — アップロードはありません。',
    dzAria: 'ファイルを追加 — ドラッグ＆ドロップするか、ここを操作してファイルを選択してください。ファイルはあなたの端末内で処理されます。',
    addedFiles: '追加したファイル',
    rejectedOne: '1つのファイルはこのツールに対応していません。',
    rejectedMany: '{n} 個のファイルはこのツールに対応していません。',
    rejectedSingle: 'このツールは一度に1ファイルしか扱えないため、最初に一致したファイルだけを追加しました。',
  },
  tools: {
    'merge': {
      name: 'PDF を結合',
