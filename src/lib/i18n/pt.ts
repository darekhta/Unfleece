...
export const pt: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'Adicionar ficheiro',
    stepOptions: 'Definir opções',
    stepRun: 'Executar',
    stepDownload: 'Transferir',
    working: 'A processar…',
    cancel: 'Cancelar',
    startOver: 'Recomeçar',
    addFileFirst: 'Adicione primeiro um ficheiro.',
    fixOptions: 'Corrija as opções assinaladas.',
    progressFallback: 'A processar o seu ficheiro…',
    setupErrorTitle: 'Erro de configuração da ferramenta.',
    setupErrorBody: '{tool} precisa do seu editor dedicado.',
    largeTitle: 'Aviso de ficheiro grande.',
    largeBody: 'Esta ferramenta continua a correr localmente, mas a memória do navegador pode torná-la mais lenta ou fazê-la falhar neste dispositivo.',
    doneOne: 'Pronto — o seu ficheiro está disponível.',
    doneMany: 'Pronto — os seus ficheiros estão disponíveis.',
    reviewText: 'Reveja a pré-visualização do texto ou transfira o resultado.',
    extractedText: 'Texto extraído · {n} caracteres',
    copy: 'Copiar',
    madeHere: 'Feito aqui mesmo, no seu navegador. Nunca o vimos.',
    kindImage: 'Imagem',
    kindFile: 'Ficheiro',
    dropOne: 'Largue aqui um(a) {kind}, ou clique para escolher',
    dropMany: 'Largue aqui {kind}s, ou clique para escolher',
    dzTypesOne: '{kind} · um ficheiro',
    dzTypesMany: '{kind} · um ou vários',
    dzPrivacy: 'Os ficheiros ficam no seu dispositivo — sem envio para a internet.',
    dzAria: 'Adicione ficheiros — arraste e largue, ou ative para escolher ficheiros. Os ficheiros são processados no seu dispositivo.',
    addedFiles: 'Ficheiros adicionados',
    rejectedOne: 'Um ficheiro não corresponde a esta ferramenta.',
    rejectedMany: '{n} ficheiros não correspondem a esta ferramenta.',
    rejectedSingle: 'Esta ferramenta usa um ficheiro de cada vez, por isso apenas o primeiro ficheiro compatível foi adicionado.',
  },
  tools: {
    merge: {
      name: 'Juntar PDF',
