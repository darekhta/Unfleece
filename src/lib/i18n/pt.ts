...
export const pt: LocaleBundle = {
  ...
  toolPage: {
    ...
    usBullets: ['Funciona no seu navegador — sem envios', 'Gratuito, sem conta, sem cartão', 'Código aberto (AGPL-3.0)', 'Sem cobrança por tamanho de ficheiro'],
