...
export const fr: LocaleBundle = {
  ...
  toolPage: {
    ...
    nothingUploaded: 'Rien n’a été envoyé',
    ...
    usBullets: ['Fonctionne dans votre navigateur — aucun envoi', 'Gratuit, sans compte, sans carte bancaire', 'Open source (AGPL-3.0)', 'Aucune limite de taille payante'],
