...
export const fr: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'Ajouter un fichier',
    stepOptions: 'Définir les options',
    stepRun: 'Lancer',
    stepDownload: 'Télécharger',
    working: 'En cours…',
    cancel: 'Annuler',
    startOver: 'Recommencer',
    addFileFirst: 'Ajoutez d\'abord un fichier.',
    fixOptions: 'Corrigez les options signalées.',
    progressFallback: 'Traitement de votre fichier…',
    setupErrorTitle: 'Erreur de configuration de l\'outil.',
    setupErrorBody: '{tool} a besoin de son éditeur dédié.',
    largeTitle: 'Avertissement : fichier volumineux.',
    largeBody: 'Cet outil fonctionne toujours en local, mais la mémoire du navigateur peut le ralentir ou le faire échouer sur cet appareil.',
    doneOne: 'Terminé — votre fichier est prêt.',
    doneMany: 'Terminé — vos fichiers sont prêts.',
    reviewText: 'Consultez l\'aperçu du texte ou téléchargez le résultat.',
    extractedText: 'Texte extrait · {n} caractères',
    copy: 'Copier',
    madeHere: 'Réalisé ici même, dans votre navigateur. Nous ne l\'avons jamais vu.',
    kindImage: 'Image',
    kindFile: 'Fichier',
    dropOne: 'Déposez {kind} ici, ou cliquez pour choisir',
    dropMany: 'Déposez des {kind} ici, ou cliquez pour choisir',
    dzTypesOne: '{kind} · un seul fichier',
    dzTypesMany: '{kind} · un ou plusieurs',
    dzPrivacy: 'Vos fichiers restent sur votre appareil — aucun envoi.',
    dzAria: 'Ajoutez des fichiers — glissez-déposez, ou activez pour choisir des fichiers. Les fichiers sont traités sur votre appareil.',
    addedFiles: 'Fichiers ajoutés',
    rejectedOne: 'Un fichier ne correspond pas à cet outil.',
