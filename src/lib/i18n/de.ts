...
export const de: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'Datei hinzufügen',
    stepOptions: 'Optionen festlegen',
    stepRun: 'Ausführen',
    stepDownload: 'Herunterladen',
    working: 'Wird verarbeitet…',
    cancel: 'Abbrechen',
    startOver: 'Neu beginnen',
    addFileFirst: 'Füge zuerst eine Datei hinzu.',
    fixOptions: 'Bitte die markierten Optionen korrigieren.',
    progressFallback: 'Deine Datei wird verarbeitet…',
    setupErrorTitle: 'Fehler beim Einrichten des Tools.',
    setupErrorBody: '{tool} braucht seinen eigenen Editor.',
    largeTitle: 'Hinweis: große Datei.',
    largeBody: 'Dieses Tool läuft weiterhin lokal, aber der Arbeitsspeicher des Browsers kann es auf diesem Gerät verlangsamen oder scheitern lassen.',
    doneOne: 'Fertig — deine Datei ist bereit.',
    doneMany: 'Fertig — deine Dateien sind bereit.',
    reviewText: 'Sieh dir die Textvorschau an oder lade das Ergebnis herunter.',
    extractedText: 'Extrahierter Text · {n} Zeichen',
    copy: 'Kopieren',
    madeHere: 'Direkt hier in deinem Browser erstellt. Wir haben sie nie gesehen.',
    kindImage: 'Bild',
    kindFile: 'Datei',
    dropOne: 'Lege hier eine {kind}-Datei ab oder klicke zum Auswählen',
    dropMany: 'Lege hier {kind}-Dateien ab oder klicke zum Auswählen',
    dzTypesOne: '{kind} · eine Datei',
    dzTypesMany: '{kind} · einzeln oder mehrere',
    dzPrivacy: 'Dateien bleiben auf deinem Gerät — kein Datei-Upload.',
    dzAria: 'Dateien hinzufügen — per Drag-and-drop oder aktivieren, um Dateien auszuwählen. Dateien werden auf deinem Gerät verarbeitet.',
    addedFiles: 'Hinzugefügte Dateien',
    rejectedOne: 'Eine Datei passt nicht zu diesem Tool.',
    rejectedMany: '{n} Dateien passen nicht zu diesem Tool.',
    rejectedSingle: 'Dieses Tool verarbeitet jeweils nur eine Datei, daher wurde nur die erste passende Datei hinzugefügt.',
  },
  tools: {
    merge: {
