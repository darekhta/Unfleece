...
export const it: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'Aggiungi file',
    stepOptions: 'Imposta le opzioni',
    stepRun: 'Esegui',
    stepDownload: 'Scarica',
    working: 'In corso…',
    cancel: 'Annulla',
    startOver: 'Ricomincia',
    addFileFirst: 'Aggiungi prima un file.',
    fixOptions: 'Correggi le opzioni evidenziate.',
    progressFallback: 'Stiamo elaborando il tuo file…',
    setupErrorTitle: 'Errore di configurazione dello strumento.',
    setupErrorBody: '{tool} richiede il suo editor dedicato.',
    largeTitle: 'Attenzione: file di grandi dimensioni.',
    largeBody: 'Questo strumento funziona comunque in locale, ma la memoria del browser potrebbe renderlo più lento o farlo fallire su questo dispositivo.',
    doneOne: 'Fatto — il tuo file è pronto.',
    doneMany: 'Fatto — i tuoi file sono pronti.',
    reviewText: 'Controlla l\'anteprima del testo o scarica il risultato.',
    extractedText: 'Testo estratto · {n} caratteri',
    copy: 'Copia',
    madeHere: 'Creato proprio qui nel tuo browser. Non l\'abbiamo mai visto.',
    kindImage: 'Immagine',
    kindFile: 'File',
    dropOne: 'Trascina qui un {kind}, oppure clicca per scegliere',
    dropMany: 'Trascina qui i {kind}, oppure clicca per scegliere',
    dzTypesOne: '{kind} · un solo file',
    dzTypesMany: '{kind} · uno o più file',
    dzPrivacy: 'I file restano sul tuo dispositivo — nessun caricamento.',
    dzAria: 'Aggiungi file — trascina e rilascia, oppure attiva per scegliere i file. I file vengono elaborati sul tuo dispositivo.',
    addedFiles: 'File aggiunti',
    rejectedOne: 'Un file non è compatibile con questo strumento.',
    rejectedMany: '{n} file non sono compatibili con questo strumento.',
    rejectedSingle: 'Questo strumento elabora un file alla volta, quindi è stato aggiunto solo il primo file compatibile.',
  },
  tools: {
    merge: {
      name: 'Unisci PDF',
