...
export const es: LocaleBundle = {
  ...
  runner: {
    stepAdd: 'Añadir archivo',
    stepOptions: 'Configurar opciones',
    stepRun: 'Ejecutar',
    stepDownload: 'Descargar',
    working: 'Procesando…',
    cancel: 'Cancelar',
    startOver: 'Empezar de nuevo',
    addFileFirst: 'Añade un archivo primero.',
    fixOptions: 'Corrige las opciones marcadas.',
    progressFallback: 'Procesando tu archivo…',
    setupErrorTitle: 'Error de configuración de la herramienta.',
    setupErrorBody: '{tool} necesita su editor específico.',
    largeTitle: 'Aviso de archivo grande.',
    largeBody: 'Esta herramienta sigue funcionando en local, pero la memoria del navegador puede hacerla más lenta o fallar en este dispositivo.',
    doneOne: 'Listo — tu archivo ya está preparado.',
    doneMany: 'Listo — tus archivos ya están preparados.',
    reviewText: 'Revisa la vista previa del texto o descarga el resultado.',
    extractedText: 'Texto extraído · {n} caracteres',
    copy: 'Copiar',
    madeHere: 'Hecho aquí mismo, en tu navegador. Nosotros nunca lo vimos.',
    kindImage: 'imagen',
    kindFile: 'archivo',
    dropOne: 'Suelta un {kind} aquí, o haz clic para elegir',
    dropMany: 'Suelta {kind}s aquí, o haz clic para elegir',
    dzTypesOne: '{kind} · un archivo',
    dzTypesMany: '{kind} · uno o varios',
    dzPrivacy: 'Los archivos se quedan en tu dispositivo — no se sube nada.',
    dzAria: 'Añade archivos — arrastra y suelta, o activa para elegir archivos. Los archivos se procesan en tu dispositivo.',
    addedFiles: 'Archivos añadidos',
    rejectedOne: 'Un archivo no es compatible con esta herramienta.',
    rejectedMany: '{n} archivos no son compatibles con esta herramienta.',
    rejectedSingle: 'Esta herramienta usa un archivo a la vez, así que solo se añadió el primer archivo compatible.',
  },
  tools: {
    merge: {
      name: 'Unir PDF',
