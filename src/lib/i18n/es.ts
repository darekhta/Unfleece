...
export const es: LocaleBundle = {
  ...
  toolPage: {
    ...
    nothingUploaded: 'No se ha subido nada',
    ...
    usBullets: ['Funciona en tu navegador, sin subidas', 'Gratis, sin cuenta, sin tarjeta', 'Código abierto (AGPL-3.0)', 'Sin muro de pago por tamaño de archivo'],
